...
\item{\bf DP00 \& P01 (no longer used)}: (\citealt{diaz00} and \citealt{pilyugin01}, respectively) are also available, but no longer used: P01 is superseded by P05. Therefore they are not part of the default output; however, they are available upon explicit user request, via the command line options. 
\end{itemize}

All of the above calibrations, except those of DP00, M08, P10, M13 and D13 (i.e., \verb=pyqz=) are calculated in the original IDLKD02 code, and are discussed in detail in \citet{kewley02,kewley08}. 
...
%FBB rephrased
%MM: Fed I don't understand what you mean by "The way in which the lines are combined" - do you mean how the metallicity is derived based on emission line ratio? The way you have it sounds confusing and out of context (lines of evidence?)
