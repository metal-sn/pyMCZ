...
%FED i do not know what that means. i would think that this method is NOT conservative on account of that! MM: OK took it out.
...
%% MM: instead of Input parameters shouldn't it be input data values?
...
%MM: ahhh thanks! So then for clarity, what about putting that factor/shift in the x-axis label? "Time (1e-3+1.177 sec)" or something like that?
