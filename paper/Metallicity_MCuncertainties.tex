...
%chaffau Z=0.0209 12+log=O/H) = 8.76±0.07 or is it Z=0.0153 12+log(O/H)??
...
\item {\bf C01}: a diagnostic based on $R_{23}$, C01\_$R_{23}$, and one based on [NII]/[SII], C01\_N2S2  \citep{charlot01}, \textbf{CHECK}%# - which is however deprecated) 
