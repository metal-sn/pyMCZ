...
\includegraphics[width=0.98\columnwidth]{exampledata_n2000_KD02comb_update_1.pdf}}
...
%(KD comb KK04\_$R_{23}$, KDcomb\_new) 
%(,\citealt{kewley08}). \textbf{FINISH CHECK}
...
%  \includegraphics[trim = 10mm 0mm 10mm 0mm, clip]{abcomparison6.eps}
  \includegraphics[width=1.0\columnwidth]{exampledata_n2000_KD02comb_update_1KDE.pdf}
